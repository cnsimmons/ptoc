...
def gca_calculation(sphere_data, sphere_mask, roi_ts, psy):
    sphere_ts = sphere_data.reshape(-1, sphere_data.shape[-1]).T
    sphere_mean_ts = np.mean(sphere_ts, axis=1)
    
    if sphere_mean_ts.shape[0] != roi_ts.shape[0]:
        ...
        for rcn, rc in enumerate(run_combos):
            ...
            def searchlight_function(sphere_data, sphere_mask):
                ...
                try:
                    ...
                    # Alternatively, you could add a user input check:
