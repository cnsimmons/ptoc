            ...
            for roi in rois:
                for hemi in hemispheres:
                    ...
                    for combo_idx, rc in run_pairs.items():
                        ...
                        # FDR CORRECTION ACROSS ALL VOXELS
                        brain_mask = mask > 0
                        flat_data = sl_result[brain_mask]
                        significant = multipletests(flat_data, method='fdr_bh', alpha=0.05)[0]
                        sl_result[brain_mask] = significant
