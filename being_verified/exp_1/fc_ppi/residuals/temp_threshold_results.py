#!/usr/bin/env python3
"""
Partial Correlation Threshold Analysis - pIPS Version
Applies the same FDR thresholding used in the main FC/PPI analyses
Testing pIPS (dorsal) independence by removing LO (ventral) influence
"""
...
def main():
    ...
    print("pIPS (DORSAL) Independence Analysis: removing LO influence")
    print("=" * 60)
    ...
    output_dir = f'{results_dir}/partial_correlation_thresh_pIPS'
    ...
    for hemisphere in hemispheres:
        ...
        # Load cleaned pIPS maps (pIPS with LO regressed out)
        ...
        fig.suptitle(f'Partial Correlation Analysis - {hemisphere.title()} Hemisphere\n'
                    f'pIPS Independence Test: FDR α={alpha}, cluster>{cluster_threshold}', 
    ...
    results_csv = f'{output_dir}/pIPS_retention_analysis_results.csv'
