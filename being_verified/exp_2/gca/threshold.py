...
def main():
    ...
    group_out_dir = f'{results_dir}/gca_group_averages_exp2'
    ...
    for condition in conditions:
        ...
        for roi in rois:
            for hemi in hemispheres:
                ...
                out_file = f'{group_out_dir}/{condition}_{roi_hemi}_gca_thresh.nii.gz'
...
def create_2x2_visualization(condition, thresholded_imgs, global_max, output_dir, rois, hemispheres):
    ...
    # Save the figure
    plt.savefig(f'{output_dir}/gca_{condition}_combined_brain_visualizations.png', dpi=300, bbox_inches='tight')
    print(f"Saved {condition} visualization to {output_dir}/gca_{condition}_combined_brain_visualizations.png")
    plt.close(fig)
